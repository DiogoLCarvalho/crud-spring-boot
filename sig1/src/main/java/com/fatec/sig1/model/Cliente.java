...
// @ entity - indica q essa classe vai ser uma tabela no banco de dados

// Restrições:
// NotBlank - Não pode deixar o nome em branco
// regex - para a data, tem q seguir um padrão

// Id - gerado automaticamente
// DataCadastro - o proprio sistema gera pelo método dessa classe, veja o set dele
