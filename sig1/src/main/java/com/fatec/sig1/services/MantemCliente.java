...
// Isso é uma API - Construção disponível da linguagem q abstrai a complexidade do código, usando uma sintaxe mais simples
// O resultados vão ser trazidos daqui
